...
app.include_router(integrations_router, prefix="/api/integrations", tags=["integrations-direct"])
...
app.include_router(sentiment_router, prefix=f"{settings.API_V1_STR}/sentiment", tags=["sentiment-prefixed"])
