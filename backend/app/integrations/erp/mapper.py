...
def map_erp_row(row: Dict[str, Any], custom_mappings: Optional[Dict[str, str]] = None) -> NormalizedEmployee:
    """
    Maps a raw ERP row into a NormalizedEmployee using either default or dynamic database mappings.
    """
    mapping = dict(DEFAULT_ERP_MAPPING)
    if custom_mappings:
